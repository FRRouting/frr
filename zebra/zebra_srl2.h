...
/*
 * Device-wide SRv6 L2 (sr6) encapsulation policy applied to every srl2 tunnel
 ...
 *
 * A change takes effect for srl2 interfaces created afterwards; interfaces
 * already in the kernel keep their mode until they are recreated (the sr6
 * driver has no changelink to reprogram it in place).
 */
enum zebra_srl2_encap_mode {
	ZEBRA_SRL2_ENCAP_MODE_FULL = 0,
	ZEBRA_SRL2_ENCAP_MODE_REDUCED = 1,
};
