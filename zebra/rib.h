 ...
 */
extern int rib_add_multipath(afi_t afi, safi_t safi, const struct prefix *p,
			     struct prefix_ipv6 *src_p, struct route_entry *re,
			     struct nexthop_group *ng, bool startup, bool replace);
 ...
 *  1 -> an update
 */
extern int rib_add_multipath_nhe(afi_t afi, safi_t safi, const struct prefix *p,
				 struct prefix_ipv6 *src_p, struct route_entry *re,
				 struct nhg_hash_entry *nhe, bool startup, bool replace);

/*
 * Manage local host routes
 */
