...
struct nexthop parse_nexthop_unicast(ns_id_t ns_id, unsigned rtm_flags, struct rtattr **tb,
...
uint16_t parse_multipath_nexthops_unicast(ns_id_t ns_id, struct nexthop_group *ng,
