...
/*
 * Helper function to create the SRv6 compressed format `usid-f4024`.
 */
static struct srv6_sid_format *create_srv6_sid_format_usid_f4024(void)
{
	struct srv6_sid_format *format = NULL;

	format = srv6_sid_format_alloc(SRV6_SID_FORMAT_USID_F4024_NAME);

	format->type = SRV6_SID_FORMAT_TYPE_USID;

	/* Define block/node/function length */
	format->block_len = SRV6_SID_FORMAT_USID_F4024_BLOCK_LEN;
	format->node_len = SRV6_SID_FORMAT_USID_F4024_NODE_LEN;
	format->function_len = SRV6_SID_FORMAT_USID_F4024_FUNCTION_LEN;
	format->argument_len = SRV6_SID_FORMAT_USID_F4024_ARGUMENT_LEN;

	/* Define the ranges from which the SID function can be allocated */
	format->config.usid.lib_start = SRV6_SID_FORMAT_USID_F4024_LIB_START;
	format->config.usid.elib_start = SRV6_SID_FORMAT_USID_F4024_ELIB_START;
	format->config.usid.elib_end = SRV6_SID_FORMAT_USID_F4024_ELIB_END;
	format->config.usid.wlib_start = SRV6_SID_FORMAT_USID_F4024_WLIB_START;
	format->config.usid.wlib_end = SRV6_SID_FORMAT_USID_F4024_WLIB_END;
	format->config.usid.ewlib_start = SRV6_SID_FORMAT_USID_F4024_EWLIB_START;
...
struct zebra_srv6 *zebra_srv6_get_default(void)
{
	...
	struct srv6_sid_format *format_usidf4024;
	...
	if (first_execution) {
		...
		/* Create SID format `usid-f4024` */
		format_usidf4024 = create_srv6_sid_format_usid_f4024();
		srv6_sid_format_register(format_usidf4024);
