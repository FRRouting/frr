...
/*
 * Rebuild nhg_depends from the NHE's current nexthop list (after in-place
 * rework).  'afi' is the AFI of the route driving the rework, not nhe->afi.
 */
extern void zebra_nhg_rebuild_depends(struct nhg_hash_entry *nhe, afi_t afi);
