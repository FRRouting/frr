 ...
 */
int
lib_route_map_entry_set_action_rmap_set_action_srv6_encap_source_modify(
	struct nb_cb_modify_args *args)
{
	struct routemap_hook_context *rhc;
...
int
lib_route_map_entry_set_action_rmap_set_action_srv6_encap_source_destroy(
	struct nb_cb_destroy_args *args)
{
	switch (args->event) {
	case NB_EV_VALIDATE:
