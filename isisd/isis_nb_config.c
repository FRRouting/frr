...
void area_password_apply_finish(struct nb_cb_apply_finish_args *args)
{
	...
	uint8_t snp_auth = yang_dnode_get_enum(args->dnode,
					       "./authenticate-snp");
...
/*
 *  XPath: /frr-isisd:isis/intance/route_leanking/ipv4
 */
void leanking_apply_finish(const struct lyd_node *dnode, int family)
{
	...
	isis_redist_set_route_leanking(area, level, family, type, metric,
				       routemap, 0, 0);
...
{
	leanking_apply_finish(args->dnode, AF_INET);
}

void leanking_ipv6_apply_finish(struct nb_cb_apply_finish_args *args)
{
	leanking_apply_finish(args->dnode, AF_INET6);
}
 ...
 */
int isis_instance_route_leanking_ipv4_metric_modify(struct nb_cb_modify_args *args)
{
	/* It's all done by redistribute_apply_finish */
	return NB_OK;
}
 ...
 */
int isis_instance_route_leanking_ipv4_table_create(struct nb_cb_create_args *args)
{
	uint16_t table;
	int type, level;
	unsigned long metric = 0;
	...
	isis_redist_set_route_leanking(area, level, AF_INET, type, metric,
				       routemap, 0, table);
	...
	struct nb_cb_destroy_args *args)
{
	...
	isis_leanking_unset(area, routemap);
 ...
 */
int isis_instance_route_leanking_ipv6_metric_modify(struct nb_cb_modify_args *args)
{
	/* It's all done by redistribute_apply_finish */
	return NB_OK;
}
 ...
 */
int isis_instance_route_leanking_ipv6_table_create(struct nb_cb_create_args *args)
{
	if (args->event != NB_EV_APPLY)
		return NB_OK;
