...
static struct srcdest_rnode *srcdest_rnode_from_rnode(struct route_node
                                                      *rn)
{
...
static struct route_node *srcdest_rnode_create(route_table_delegate_t *
                                               delegate,
...
static struct route_node *srcdest_srcnode_create(route_table_delegate_t *
                                                 delegate,
                                                 struct route_table *table)
{
