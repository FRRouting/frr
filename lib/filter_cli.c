...
DEFPY_YANG(
	...
	"ipv6 access-list WORD$name [seq (1-4294967295)$seq] <deny|permit>$action ipv6 <X:X::X:X$src X:X::X:X$src_mask|host X:X::X:X$src|any> <X:X::X:X$dst X:X::X:X$dst_mask|host X:X::X:X$dst|any>",
	IPV6_STR
	ACCESS_LIST_STR
	ACCESS_LIST_ZEBRA_STR
	ACCESS_LIST_SEQ_STR
...
DEFPY_YANG(
	...
	"no ipv6 access-list WORD$name [seq (1-4294967295)$seq] <deny|permit>$action ipv6 <X:X::X:X$src X:X::X:X$src_mask|host X:X::X:X$src|any> <X:X::X:X$dst X:X::X:X$dst_mask|host X:X::X:X$dst|any>",
	NO_STR
	IPV6_STR
	ACCESS_LIST_STR
	ACCESS_LIST_ZEBRA_STR
