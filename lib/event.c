...
#endif
DEFUN_NOSH(show_event_cpu, show_event_cpu_cmd, "show event cpu [FILTER]",
...
ALIAS(show_event_cpu, show_thread_cpu_cmd, "show thread cpu [FILTER]",
...
ALIAS(show_event_poll, show_thread_poll_cmd, "show thread poll",
      SHOW_STR "Thread information\n"
...
ALIAS(show_event_timers, show_thread_timers_cmd, "show thread timers",
      SHOW_STR "Thread information\n"
	       "Show all timers and how long they have in the system\n")
