...
enum srv6_endpoint_behavior_codepoint {
	...
	SRV6_ENDPOINT_BEHAVIOR_END_UDX2    = 0x0041,
	SRV6_ENDPOINT_BEHAVIOR_END_UDX2V    = 0x0042,
	SRV6_ENDPOINT_BEHAVIOR_END_UDT2U    = 0x0043,
	SRV6_ENDPOINT_BEHAVIOR_END_UDT2M    = 0x0044,
