...
typedef enum {
	...
	IANA_AFI_CRYPTO_ROUTES = 16400, /* Lab-only experimental value */
} iana_afi_t;
...
typedef enum {
	...
	IANA_SAFI_CRYPTO_ROUTES = 241 /* Private Use */
} iana_safi_t;
