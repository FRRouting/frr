...
DEFUNSH(VTYSH_ZEBRA, srv6_sid_format_f4024_usid, srv6_sid_format_f4024_usid_cmd,
	"format usid-f4024",
	"Configure SRv6 SID format\n"
	"Configure the uSID f4024 format\n")
{
	vty->node = SRV6_SID_FORMAT_USID_F4024_NODE;
	return CMD_SUCCESS;
}
...
void vtysh_init_vty(void)
{
	...
	install_element(SRV6_SID_FORMAT_USID_F4024_NODE, &exit_srv6_sid_format_cmd);
	install_element(SRV6_SID_FORMAT_USID_F4024_NODE, &vtysh_end_all_cmd);
