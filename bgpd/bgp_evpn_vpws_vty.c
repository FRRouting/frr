...
DEFPY_NOSH (bgp_evpn_vpws_instance,
...
DEFPY (no_bgp_evpn_vpws_instance,
       no_bgp_evpn_vpws_instance_cmd,
       "no vpws-instance WORD$name",
       NO_STR
       "EVPN-VPWS service\n"
       "Service instance name\n")
{
...
DEFPY (bgp_evpn_vpws_id,
       bgp_evpn_vpws_id_cmd,
       "vpws-id source (1-4294967295)$source target (1-4294967295)$target",
...
DEFPY (bgp_evpn_vpws_evi,
       bgp_evpn_vpws_evi_cmd,
       "vpws-evi (1-16777215)$evi",
...
DEFPY (bgp_evpn_vpws_rt,
       bgp_evpn_vpws_rt_cmd,
       "route-target <import|export|both>$dir RTLIST...",
       "Route Target\n"
       "Import direction\n"
       "Export direction\n"
...
DEFPY (no_bgp_evpn_vpws_rt,
       no_bgp_evpn_vpws_rt_cmd,
       "no route-target <import|export|both>$dir",
       NO_STR
       "Route Target\n"
       "Import direction\n"
       "Export direction\n"
...
DEFPY (bgp_evpn_vpws_interface_sid,
       ...
       "interface IFNAME$ifname [sid auto$sid_auto] bridge IFNAME2$brname",
       "Bind attachment circuit interface\n"
       "Interface name\n"
       "SRv6 SID allocation\n"
       "Auto allocate from BGP-bound locator\n"
       "Operator-created bridge dedicated to this VPWS instance\n"
       "Bridge interface name\n")
{
	VTY_DECLVAR_CONTEXT_SUB(bgp_evpn_vpws, ctx);

	if (bgp_evpn_vpws_set_interface(ctx, ifname, !!sid_auto, brname) < 0) {
