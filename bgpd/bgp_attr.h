...
static inline struct bgp_attr_srv6_service *bgp_attr_get_srv6_l3service(const struct attr *attr)
{
...
static inline void bgp_attr_set_srv6_l3service(struct attr *attr,
					       struct bgp_attr_srv6_service *srv6_l3service)
{
	struct bgp_attr_srv6_service *old = bgp_attr_get_srv6_l3service(attr);
