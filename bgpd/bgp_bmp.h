 ...
 * per AFI/SAFI is not sent if 0 and force_zero == false
 */
#define BMP_PER_AF_STAT(afi_var, safi_var, af_stat_arr, sum_var, safi_stat, safi_stat_call,       \
			sum_stat_call, force_zero)                                                \
	do {                                                                                      \
		(sum_var) = 0;                                                                    \
