...
#define BGP_TOVPN_SID_TRANSPOSE_LABEL_0 0
#define BGP_TOVPN_SID_TRANSPOSE_LABEL_3 3
...
extern void ensure_vrf_tovpn_sid_explicit(struct bgp *bgp_vpn, struct bgp *bgp_vrf, afi_t afi);
