 ...
 */
static int is_vni_present_in_irt_vnis(struct list *vnis, struct bgp_evpn_evi *vpn)
{
 ...
 */
static void map_vni_to_rt(struct bgp *bgp, struct bgp_evpn_evi *vpn,
 ...
 */
static void unmap_vni_from_rt(struct bgp *bgp, struct bgp_evpn_evi *vpn,
			      struct irt_node *irt)
{
 ...
 * creation of a VNI.
 */
static void derive_rd_rt_for_vni(struct bgp *bgp, struct bgp_evpn_evi *vpn)
{
 ...
 * RT is changed.
 */
static int install_routes_for_vni(struct bgp *bgp, struct bgp_evpn_evi *vpn)
{
	/*
 ...
 */
static int uninstall_routes_for_vni(struct bgp *bgp, struct bgp_evpn_evi *vpn)
{
	/*
 ...
 * freeing the bgp_evpn_evi struct itself.  Used during early cleanup so that the
 ...
 */
int bgp_evpn_handle_export_rt_change(struct bgp *bgp, struct bgp_evpn_evi *vpn)
{
 ...
 */
void bgp_evpn_handle_rd_change(struct bgp *bgp, struct bgp_evpn_evi *vpn,
			       int withdraw)
{
	if (withdraw)
		delete_withdraw_vni_routes(bgp, vpn);
 ...
 */
int bgp_evpn_install_routes(struct bgp *bgp, struct bgp_evpn_evi *vpn)
{
 ...
 * to Import RT.
 */
int bgp_evpn_uninstall_routes(struct bgp *bgp, struct bgp_evpn_evi *vpn)
{
 ...
 * The mapping will be used during route processing.
 */
void bgp_evpn_derive_auto_rt_import(struct bgp *bgp, struct bgp_evpn_evi *vpn)
{
 ...
 */
void bgp_evpn_derive_auto_rt_export(struct bgp *bgp, struct bgp_evpn_evi *vpn)
{
 ...
 * is of the form RouterId:unique-id-for-vni.
 */
void bgp_evpn_derive_auto_rd(struct bgp *bgp, struct bgp_evpn_evi *vpn)
{
