...
static void srv6_l3vpn_free(struct bgp_attr_srv6_l3service *l3vpn)
{
	XFREE(MTYPE_BGP_SRV6_L3SERVICE, l3vpn);
}

static struct bgp_attr_srv6_l3service *srv6_l3vpn_intern(struct bgp_attr_srv6_l3service *l3vpn)
{
...
static void srv6_l3vpn_unintern(struct bgp_attr_srv6_l3service **l3vpnp)
{
	struct bgp_attr_srv6_l3service *l3vpn = *l3vpnp;
...
{
	const struct bgp_attr_srv6_l3service *l3vpn = p;
	uint32_t key = 0;
...
{
	const struct bgp_attr_srv6_l3service *l3vpn1 = p1;
	const struct bgp_attr_srv6_l3service *l3vpn2 = p2;
...
static bool srv6_l3vpn_same(const struct bgp_attr_srv6_l3service *h1,
