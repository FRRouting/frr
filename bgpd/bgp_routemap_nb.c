...
const struct frr_yang_module_info frr_bgp_route_map_info = {
	...
	.nodes = {
		...
		{
			.xpath = "/frr-route-map:lib/route-map/entry/set-action/rmap-set-action/frr-bgp-route-map:l3vpn-encapsulation-prefer-srv6",
			.cbs = {
				.modify = lib_route_map_entry_set_action_rmap_set_action_l3vpn_encapsulation_prefer_srv6_modify,
				.destroy = lib_route_map_entry_set_action_rmap_set_action_l3vpn_encapsulation_prefer_srv6_destroy,
			}
		},
		{
			.xpath = NULL,
