...
DEFUN (bgp_use_underlying_nexthop_weight,
...
DEFUN (no_bgp_use_underlying_nexthop_weight,
       no_bgp_use_underlying_nexthop_weight_cmd,
       "no use-underlays-nexthop-weight",
       NO_STR
       "Tell Zebra to no longer use the underlays nexthop weight for when nexthops are resolved\n")
{
	VTY_DECLVAR_CONTEXT(bgp, bgp);
...
void bgp_vty_init(void)
{
	...
	install_element(BGP_NODE, &no_bgp_use_underlying_nexthop_weight_cmd);
