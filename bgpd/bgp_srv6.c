...
/*
 * Return the seg6local action for the unicast SID for a given AFI.
 */
static enum seg6local_action_t bgp_srv6_unicast_action(struct bgp *bgp, afi_t afi)
{
...
/*
 * Return the SRv6 endpoint behavior codepoint for the unicast SID.
 */
static enum srv6_endpoint_behavior_codepoint
bgp_srv6_unicast_behavior_codepoint(struct bgp *bgp, afi_t afi, struct srv6_locator *locator)
{
				     ...
				     struct bgp_path_info *bpi)
{
	...
	dest->srv6_unicast->endpoint_behavior = bgp_srv6_unicast_behavior_codepoint(bgp, afi,
										    locator);
