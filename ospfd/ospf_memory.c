...
DEFINE_MTYPE(OSPFD, OSPF_RI_FAD_TLV, "OSPF RI FAD TLV");
DEFINE_MTYPE(OSPFD, OSPF_RI_FAD_EXC_ADMNGRP_SUBTLV,
	     "OSPF RI FAD Exclude AdminGroup SubTLV");
DEFINE_MTYPE(OSPFD, OSPF_RI_FAD_INCANY_ADMNGRP_SUBTLV,
	     "OSPF RI FAD Include-Any AdminGroup SubTLV");
DEFINE_MTYPE(OSPFD, OSPF_RI_FAD_INCALL_ADMNGRP_SUBTLV,
	     "OSPF RI FAD Include-All AdminGroup SubTLV");
DEFINE_MTYPE(OSPFD, OSPF_RI_FAD_FLAGS_SUBTLV, "OSPF RI FAD Flags SubTLV");
DEFINE_MTYPE(OSPFD, OSPF_RI_FAD_EXC_SRLG_SUBTLV,
	     "OSPF RI FAD Exclude SRLG SubTLV");
DEFINE_MTYPE(OSPFD, OSPF_EXT_PREFIX_FAPM_SUBTLV, "OSPF EXT Prefix FAPM SubTLV");
DEFINE_MTYPE(OSPFD, OSPF_EXT_IAASBR_INFO, "OSPF EXT IA-ASBR LSA INFO");
DEFINE_MTYPE(OSPFD, OSPF_EXT_IAASBR_FAAM_SUBTLV,
	     "OSPF EXT IA-ASBR FAAM SubTLV");
