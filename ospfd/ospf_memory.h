...
DECLARE_MTYPE(OSPF_RI_FAD_INCANY_ADMNGRP_SUBTLV);
DECLARE_MTYPE(OSPF_RI_FAD_INCALL_ADMNGRP_SUBTLV);
DECLARE_MTYPE(OSPF_RI_FAD_FLAGS_SUBTLV);
DECLARE_MTYPE(OSPF_RI_FAD_EXC_SRLG_SUBTLV);
DECLARE_MTYPE(OSPF_EXT_PREFIX_FAPM_SUBTLV);
DECLARE_MTYPE(OSPF_EXT_IAASBR_INFO);
DECLARE_MTYPE(OSPF_EXT_IAASBR_FAAM_SUBTLV);
