...
.. clicmd:: [no] ip route A.B.C.D/M A.B.C.D {bfd [multi-hop source <A.B.C.D|auto>|auto-hop}] [profile BFDPROF}]|group STRGRP}
...
.. clicmd:: [no] ipv6 route X:X::X:X/M [from X:X::X:X/M] X:X::X:X {bfd [multi-hop source <X:X::X:X|auto>|auto-hop}] [profile BFDPROF]|group STRGRP}
