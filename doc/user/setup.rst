...
This file is usually located at :file:`/etc/frr/daemons.conf` and determines
which daemons are activated when issuing a service start / stop command via
init or systemd. The file initially looks like this:
