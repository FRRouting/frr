...
.. clicmd:: debug bgp updates prefix <A.B.C.D/M|X:X::X:X/M|ASN:X/M|ASN:0:2:EF:OPQR/M|ASN:2:2:GHJK:MN/M|ASN:1:2:A.B.C.D:MN/M>
...
.. clicmd:: debug bgp bestpath <A.B.C.D/M|X:X::X:X/M|ASN:X/M|ASN:0:2:EF:OPQR/M|ASN:2:2:GHJK:MN/M|ASN:1:2:A.B.C.D:MN/M>
...
.. clicmd:: show [ip] bgp ipv4 rtfilter <ASN:0:2:EF:OPQR|ASN:2:2:GHJK:MN|ASN:X/M|ASN:1:2:A.B.C.D:MN|ASN:0:2:EF:OPQR/M|ASN:2:2:GHJK:MN/M|ASN:1:2:A.B.C.D:MN/M> [<bestpath|multipath>] [json]
...
.. clicmd:: show [ip] bgp [afi] [safi] [all] neighbors A.B.C.D [advertised-routes|received-routes|filtered-routes] [<A.B.C.D/M|X:X::X:X/M|ASN:X/M|ASN:0:2:EF:OPQR/M|ASN:2:2:GHJK:MN/M|ASN:1:2:A.B.C.D:MN/M> | detail] [json [brief] | wide]
...
the ``ipv4 rtfilter`` address-family.
...
It is worth noting that :rfc:4684 introduces a new "rtfilter" Sub-Address Family Indicator
(SAFI), which is always associated with the IPv4 Address Family Indicator (AFI). The ipv4
rtfilter AFI/SAFI designation can be somewhat misleading, as the RFC specifies that it
...
In other words, activating ipv4 rtfilter on multiple neighbors towards the same peer is
unnecessary.
