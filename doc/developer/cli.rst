...
+-------------------------+--------------------------+-------------------------------------------------------+
| ``RTC_WILDCARD``        | ``ASN:X``                | Matches RTC wildcard: ASN:* or *:*                    |
+-------------------------+--------------------------+-------------------------------------------------------+
| ``RTC_WILDCARD_PREFIX`` | ``ASN:X/M``              | Matches RTC wildcard with a mask: ASN:*/32 or *:*/0   |
+-------------------------+--------------------------+-------------------------------------------------------+
| ``RTC_AS2``             | ``ASN:0:2:EF:OPQR``      | Matches RTC format with 2-bytes AS community          |
+-------------------------+--------------------------+-------------------------------------------------------+
| ``RTC_AS2_PREFIX``      | ``ASN:0:2:EF:OPQR/M``    | Matches RTC format with 2-bytes AS with a mask.       |
+-------------------------+--------------------------+-------------------------------------------------------+
| ``RTC_AS4``             | ``ASN:2:2:GHJK:MN``      | Matches RTC format with 4-bytes AS community          |
+-------------------------+--------------------------+-------------------------------------------------------+
| ``RTC_AS4_PREFIX``      | ``ASN:2:2:GHJK:MN/M``    | Matches RTC format with 4-bytes AS with a mask.       |
+-------------------------+--------------------------+-------------------------------------------------------+
| ``RTC_IP``              | ``ASN:1:2:A.B.C.D:MN``   | Matches RTC format with IP community                  |
+-------------------------+--------------------------+-------------------------------------------------------+
| ``RTC_IP_PREFIX``       | ``ASN:1:2:A.B.C.D:MN/M`` | Matches RTC format with IP community with a mask.     |
+-------------------------+--------------------------+-------------------------------------------------------+
