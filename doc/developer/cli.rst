...
+--------------------+--------------------------+-------------------------------------------------------+
| ``RTC_AS2``        | ``ASN:rt:EF:OPQR``       | Matches RTC format with 2-bytes AS community          |
+--------------------+--------------------------+-------------------------------------------------------+
| ``RTC_AS2_PREFIX`` | ``ASN:rt:EF:OPQR/M``     | Matches RTC format with 2-bytes AS with a mask.       |
+--------------------+--------------------------+-------------------------------------------------------+
| ``RTC_AS4``        | ``ASN:rt:GHJK:MN``       | Matches RTC format with 4-bytes AS community          |
+--------------------+--------------------------+-------------------------------------------------------+
| ``RTC_AS4_PREFIX`` | ``ASN:rt:GHJK:MN/M``     | Matches RTC format with 4-bytes AS with a mask.       |
+--------------------+--------------------------+-------------------------------------------------------+
| ``RTC_IP``         | ``ASN:rt:A.B.C.D:MN``    | Matches RTC format with IP community                  |
+--------------------+--------------------------+-------------------------------------------------------+
| ``RTC_IP_PREFIX``  | ``ASN:rt:A.B.C.D:MN/M``  | Matches RTC format with IP community with a mask.     |
+--------------------+--------------------------+-------------------------------------------------------+
