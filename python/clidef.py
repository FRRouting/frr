...
class UnsignedLongHandler(RenderHandler):
    argtype = "unsigned long"
    decl = Template("unsigned long $varname = 0;")
    code = Template(
        """\
char *_end;
$varname = strtoul(argv[_i]->arg, &_end, 10);
