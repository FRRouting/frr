...
ret = luCommand(
    "r1",
    "ping 29.0.0.1 -I r1-cust5 -I 29.0.0.1 -c 1",
    " 0. packet loss",
    "pass",
...
luCommand(
    "r1",
    "ping 192.168.1.1 -I r1-cust5 -I 29.0.0.1 -c 1",
    " 0. packet loss",
    "pass",
...
luCommand(
    "r1",
    "ping 192.168.1.2 -I r1-cust5 -I 29.0.0.1 -c 1",
    " 0. packet loss",
    "wait",
...
luCommand(
    "r1",
    "ping 99.0.0.1 -I r1-cust5 -I 29.0.0.1 -c 1",
    " 0. packet loss",
    "pass",
...
luCommand(
    "r1",
    "ping 5.1.0.1 -I r1-cust5 -I 29.0.0.1 -c 1",
    " 0. packet loss",
    "wait",
    "R1(r1-cust5)->CE1 (loopback) ping",
    time=30,
