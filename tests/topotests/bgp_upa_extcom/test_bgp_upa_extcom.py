...
def test_bgp_upa_extcom_convergence():
    ...
    _, result = topotest.run_and_expect(_converged, None, count=60, wait=0.5)
...
def test_bgp_upa_extcom_no_drop_flag():
    ...
    _, result = topotest.run_and_expect(_check, None, count=30, wait=0.5)
...
def test_bgp_upa_aggregate_no_upa_by_default():
    ...
    success, result = topotest.run_and_expect(_aggregate_present, None, count=30, wait=0.5)
...
def test_bgp_upa_aggregate_free_no_crash():
    ...
    success, result = topotest.run_and_expect(_session_healthy, None, count=30, wait=0.5)
    assert success, \
...
def test_no_origination_when_disabled():
    ...
    success, result = topotest.run_and_expect(_prefix_present, None, count=30, wait=0.5)
    assert success, result
...
def test_aggregate_upa_basic_origination():
    ...
    topotest.run_and_expect(_routes_installed, True, count=10, wait=0.5)
    ...
    topotest.run_and_expect(_upa_originated, True, count=10, wait=0.5)
...
def test_aggregate_upa_with_dbit():
    ...
    topotest.run_and_expect(_route_ready, True, count=10, wait=0.5)
    ...
    success, _ = topotest.run_and_expect(_upa_with_dbit, True, count=10, wait=0.5)
...
def test_aggregate_upa_withdrawal():
    ...
    success, _ = topotest.run_and_expect(_route_installed, True, count=10, wait=0.5)
...
def test_global_upa_withdrawal():
    ...
    success, _ = topotest.run_and_expect(_routes_installed, True, count=10, wait=0.5)
...
def test_upa_best_path_ranking():
    ...
    topotest.run_and_expect(_static_installed, True, count=10, wait=0.5)
    ...
    success, _ = topotest.run_and_expect(_check_best_path, True, count=20, wait=1)
...
def test_upa_blackhole_with_dbit():
    ...
    success, _ = topotest.run_and_expect(_zebra_has_blackhole, True, count=10, wait=0.5)
...
def test_upa_no_blackhole_without_dbit():
    ...
    success, _ = topotest.run_and_expect(_upa_in_bgp, True, count=10, wait=0.5)
    ...
    success, _ = topotest.run_and_expect(_not_in_zebra, True, count=5, wait=0.5)
...
def test_upa_drop_blackhole_removed_on_recovery():
    ...
    success, _ = topotest.run_and_expect(_blackhole_installed, True, count=10, wait=0.5)
    ...
    success, _ = topotest.run_and_expect(_blackhole_removed, True, count=10, wait=0.5)
...
def test_received_upa_best_path_ranking():
    ...
    success, _ = topotest.run_and_expect(_upa_received, True, count=30, wait=0.5)
...
def test_received_upa_dbit_zebra_install():
    ...
    success, _ = topotest.run_and_expect(_upa_dbit_received, True, count=30, wait=0.5)
...
def test_received_upa_no_dbit_no_zebra():
    ...
    success, _ = topotest.run_and_expect(_upa_no_dbit_received, True, count=30, wait=0.5)
...
def test_upa_announcement_with_capability():
    ...
    success, _ = topotest.run_and_expect(_upa_advertised, True, count=30, wait=0.5)
