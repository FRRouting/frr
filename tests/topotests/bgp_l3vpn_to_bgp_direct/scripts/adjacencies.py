...
luCommand('r1','ping 2.2.2.2 -c 1',' 0. packet loss','wait','PE->P (loopback) ping',60)
luCommand('r3','ping 2.2.2.2 -c 1',' 0. packet loss','wait','PE->P (loopback) ping',60)
luCommand('r4','ping 2.2.2.2 -c 1',' 0. packet loss','wait','PE->P (loopback) ping',60)
...
luCommand('r1','ping 3.3.3.3 -c 1',' 0. packet loss','pass','PE->PE (loopback) ping')
luCommand('r1','ping 4.4.4.4 -c 1',' 0. packet loss','pass','PE->PE (loopback) ping')
luCommand('r4','ping 3.3.3.3 -c 1',' 0. packet loss','pass','PE->PE (loopback) ping')
