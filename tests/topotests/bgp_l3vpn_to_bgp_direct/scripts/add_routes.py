...
luCommand(
    "r1", 'vtysh -c "show bgp next"', "99.0.0../32 valid", "wait", "See CE static NH"
)
luCommand(
    "r3", 'vtysh -c "show bgp next"', "99.0.0../32 valid", "wait", "See CE static NH"
)
luCommand(
    "r4", 'vtysh -c "show bgp next"', "99.0.0../32 valid", "wait", "See CE static NH"
)
