...
router bgp 65000
 address-family ipv4 rtfilter
  no network 65001:0:2:65000:0/64
"""
    )
...
router bgp 65000
 address-family ipv4 rtfilter
  no network 65002:0:2:65000:96/93
"""
    )
...
def test_rtc_l3vpn_topo1_step29():
    """
    Clear rtfilter bgp sessions on rr1
    """
    ...
    rname = "rr1"
    rr1 = tgen.gears[rname]
    rr1.vtysh_cmd("clear bgp ipv4 rtfilter *")
