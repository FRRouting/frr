...
"""
test_zebra_ipv6_import_table.py: Test zebra IPv6 table import functionality
"""
...
TOPOLOGY = """
    Single router zebra functionality
                         ...
                         +---+---+
    2001:db8:db02::1/48  |       |  fd15:d0bf:ab23::1/48
                     <--->+  R1   +<--->
                         |       |
                         +---+---+
"""
...
def test_zebra_urib_import(request):
    ...
    r1.vtysh_cmd(
        """
        conf term
         ipv6 route fd4c:0e24:f4c7::/48 fd15:d0bf:ab23::2 table 10
        """
    )
    ...
    r1.vtysh_cmd(
        """
        conf term
         no ipv6 route fd4c:0e24:f4c7::/48 fd15:d0bf:ab23::2 table 10
        """
    )
