...
def test_rib_ipv6_step1():
    ...
    for rname in ["rt1", "rt2", "rt3", "rt4", "rt5", "rt6"]:
        router_compare_json_output(
            rname, "show ipv6 route json", "step1/show_ipv6_route.ref"
        )
...
def test_rib_ipv6_step2():
    ...
    for rname in ["rt1", "rt2", "rt3", "rt4", "rt5", "rt6"]:
        router_compare_json_output(
            rname, "show ipv6 route json", "step2/show_ipv6_route.ref"
        )
...
def test_ping_step2():
    ...
    # check_ping("rt1", "fc00:0:9::1", False, 10, 1)
...
def test_rib_ipv6_step3():
    ...
    for rname in ["rt1", "rt2", "rt3", "rt4", "rt5", "rt6"]:
        router_compare_json_output(
            rname, "show ipv6 route json", "step3/show_ipv6_route.ref"
        )
...
def test_rib_ipv6_step4():
    ...
    for rname in ["rt1", "rt2", "rt3", "rt4", "rt5", "rt6"]:
        router_compare_json_output(
            rname, "show ipv6 route json", "step4/show_ipv6_route.ref"
        )
...
def test_rib_ipv6_step5():
    ...
    for rname in ["rt1", "rt2", "rt3", "rt4", "rt5", "rt6"]:
        router_compare_json_output(
            rname, "show ipv6 route json", "step5/show_ipv6_route.ref"
        )
...
def test_rib_ipv6_step6():
    ...
    for rname in ["rt1", "rt2", "rt3", "rt4", "rt5", "rt6"]:
        router_compare_json_output(
            rname, "show ipv6 route json", "step6/show_ipv6_route.ref"
        )
...
def test_rib_ipv6_step7():
    ...
    for rname in ["rt1", "rt2", "rt3", "rt4", "rt5", "rt6"]:
        router_compare_json_output(
            rname, "show ipv6 route json", "step7/show_ipv6_route.ref"
        )
...
def test_rib_ipv6_step8():
    ...
    for rname in ["rt1", "rt2", "rt3", "rt4", "rt5", "rt6"]:
        router_compare_json_output(
            rname, "show ipv6 route json", "step8/show_ipv6_route.ref"
        )
...
def test_rib_ipv6_step9():
    ...
    for rname in ["rt1", "rt2", "rt3", "rt4", "rt5", "rt6"]:
        router_compare_json_output(
            rname, "show ipv6 route json", "step9/show_ipv6_route.ref"
        )
