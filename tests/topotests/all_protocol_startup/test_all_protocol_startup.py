...
def test_nexthop_groups():
    ...
    logger.info("Validate NHG's installed in kernel has same nexthops with some Interface flaps")
    ...
    def _check_routes_stable():
        ...
        return post_route_count == pre_route_count and post_route6_count == pre_route6_count
    ...
    if not result:
        ...
        assert (
            ...
            pre_route_count, post_route_count, pre_route6_count, post_route6_count
        )
    ...
    if not result:
        ...
        assert (
            False
        ), "Route 6.6.6.0/24 was not removed after configuration. Current output:\n{}".format(
            output
        )

    def _check_route_counts(pre_route, pre_route6):
        post_route = net["r1"].cmd("ip route show | wc -l")
        post_route6 = net["r1"].cmd("ip -6 route show | wc -l")
        return post_route == pre_route and post_route6 == pre_route6
