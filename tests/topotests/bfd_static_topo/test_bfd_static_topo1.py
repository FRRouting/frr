...
def test_bfd_static_routes_step2():
    ...
    tgen.gears["rt1"].vtysh_cmd("no ip route 1.1.1.3/32 10.0.1.2 bfd")
    tgen.gears["rt2"].vtysh_cmd("no ip route 2.1.1.3/32 10.0.1.1 bfd")
    ...
    tgen.gears["rt1"].vtysh_cmd("no ip route 1.1.1.2/32 10.0.1.2 bfd")
    tgen.gears["rt2"].vtysh_cmd("no ip route 2.1.1.2/32 10.0.1.1 bfd")
    ...
    tgen.gears["rt1"].vtysh_cmd("no ip route 1.1.1.4/32 10.0.1.2 bfd")
    tgen.gears["rt2"].vtysh_cmd("no ip route 2.1.1.4/32 10.0.1.1 bfd")
    for rt in ["rt1", "rt2"]:
        router_compare_json_output(
