...
def _set_yang_router_id(router, protocol_type, daemon, running_line, new_value):
    ...
    Exercises the B1 config-write path end-to-end: candidate datastore set,
...
def test_ospf_yang_area_interface_cost_config():
    """B3a: areas/area[id]/interfaces/interface[name]/cost via mgmtd.
...
def test_ospf_yang_area_ranges_config():
    """B2d: areas/area/ranges/range list + advertise/cost leaves via mgmtd.
