...
some annotated code::
   ...
   class SomeTest:           # 3. pytest_cls = _pytest.python.Class(obj=SomeTest)
                             # 4. pytest_inst = _pytest.python.Instance(obj=SomeTest())
...
:py:class:`TopotatoClass` and :py:class:`TopotatoInstance` instead.  The
...
subclasses of :py:class:`TopotatoItem`::
   ...
   class SomeTest(TestBase): # 3. pytest_cls = TopotatoClass(obj=SomeTest)
                             # 4. pytest_inst = TopotatoInstance(obj=SomeTest())
