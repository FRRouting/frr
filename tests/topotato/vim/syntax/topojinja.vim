...
syn keyword jinjaStatement containedin=jinjaVarBlock,jinjaTagBlock,jinjaNested contained and if else in not or recursive as import elif endif endfor endblock for extends
...
syn region jinjaTagBlock matchgroup=jinjaTagDelim start="#%" end="\n"     containedin=ALLBUT,jinjaTagBlock,jinjaVarBlock,jinjaRaw,jinjaString,jinjaNested,jinjaComment
...
syn region jinjaComment matchgroup=jinjaCommentDelim start="##" end="\n" containedin=ALLBUT,jinjaTagBlock,jinjaVarBlock,jinjaString,jinjaComment
...
let b:current_syntax = "topojinja"

if main_syntax ==# 'topojinja'
  unlet main_syntax
endif
