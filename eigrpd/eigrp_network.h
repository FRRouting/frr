...
extern int eigrp_if_ipmulticast(struct eigrp *top, struct prefix *p, unsigned int ifindex);
...
extern void eigrp_if_update(struct interface *ifp);
extern int eigrp_if_add_allspfrouters(struct eigrp *top, struct prefix *p, unsigned int ifindex);
extern int eigrp_if_drop_allspfrouters(struct eigrp *top, struct prefix *p,
				       unsigned int ifindex);
extern void eigrp_adjust_sndbuflen(struct eigrp *eigrp, unsigned int buflen);

extern void eigrp_external_routes_refresh(struct eigrp *eigrp, int type);
