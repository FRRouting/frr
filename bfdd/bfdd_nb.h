...
int bfdd_bfd_sessions_segment_list_modify(struct nb_cb_modify_args *args);
int bfdd_bfd_sessions_segment_list_destroy(struct nb_cb_destroy_args *args);

int bfdd_bfd_sessions_multi_hop_minimum_ttl_destroy(struct nb_cb_destroy_args *args);
