...
>>>>>>> 60429aa46 (bfdd: fix recv errno filter logic in a few places)
...
=======
	...
	default:
		/* RFC5880 6.7: To be finished. */
		return false;
>>>>>>> ef88ba312 (bfdd: tighten auth header parsing skeleton)
	}
...
>>>>>>> 3a702f06b (bfdd: account for FP offset in echo length checks)
