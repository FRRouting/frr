...
#define MULTICAST_IPV4_SOURCE	   "source"
#define MULTICAST_IPV4_SOURCE_LIST "source prefix-list"
#define MULTICAST_IPV6_SOURCE	   "source-v6"
#define MULTICAST_IPV6_SOURCE_LIST "source-v6 prefix-list"
#define MULTICAST_IPV4_GROUP	   "group"
#define MULTICAST_IPV4_GROUP_LIST  "group prefix-list"
#define MULTICAST_IPV6_GROUP	   "group-v6"
